...
class RideRecord extends FirestoreRecord {
  ...
  // "is_driver_asignament" field.
  bool? _isDriverAsignament;
  bool get isDriverAsignament => _isDriverAsignament ?? false;
  bool hasIsDriverAsignament() => _isDriverAsignament != null;
  ...
  void _initializeFields() {
    ...
    _isDriverAsignament = snapshotData['is_driver_asignament'] as bool?;
  }
...
Map<String, dynamic> createRideRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'is_driver_asignament': isDriverAsignament,
    }.withoutNulls,
  );
...
class RideRecordDocumentEquality implements Equality<RideRecord> {
  ...
  bool equals(RideRecord? e1, RideRecord? e2) {
    return e1?.userLocation == e2?.userLocation &&
        ...
        e1?.isDriverAsignament == e2?.isDriverAsignament;
  }
